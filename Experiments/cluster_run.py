...
flags.DEFINE_string('comment', 'for ICML rebuttal April 2020.', 'Comment')
...
flags.DEFINE_string('workdir', '/private/home/tanmayshankar/Research/Code/MetaSkillLearning/Experiments', 'Jod command')
